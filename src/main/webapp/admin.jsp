...
<h1 style="margin-left:750px;margin-top:-650px;"><br>&nbsp;&nbsp;Admin Login</h1><br>
	<form method="post" style="margin-left:750px;"action="adminlogic.jsp">
  <div class="form-group col-md-8">
    <label><b>User Name</b></label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your User Name" name="name" required>
  </div>
